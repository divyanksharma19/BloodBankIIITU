package com.divyank.bloodbankbyiiitu;
...
import com.divyank.bloodbankbyiiitu.adapters.UserAdapter;
...
public class DispalyRequestsActivity extends AppCompatActivity {
    ...
    private void updateList(String toString) {
        temp.clear();
        for( User v : requests){
            if(v.getBloodGroup().toUpperCase().contains(toString)||toString.equalsIgnoreCase("ALL")) {
